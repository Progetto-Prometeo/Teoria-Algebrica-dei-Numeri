...
\begin{proof}
	...
	\begin{itemize}
		...
		%todo: rivedere utilizzo dei \mod, lasciano troppo spazio tra ciò che c'è prima di \mod e la scritta "mod" (in print: "x=0 mod(m)")
...
\begin{proposizione}
	...
	\begin{equation*}
	\mathbb{Z}_n^*\simeq\mathbb{Z}_{p_1^{e_1}}^*\times\ \dots \ \times\mathbb{Z}_{p_n^{e_n}}^*
	%todo: controlla cosa caspita sia successo agli indici (apici, pedici), sono troppo piccoli nella stampa! wtf? perché in anteprima di tex studio sono giusti?
	\end{equation*}
\end{proposizione}
\begin{proof}
