...
\begin{proof}
	...
	Per dimostrare la tesi procedo per induzione sul numero di elementi 
\end{proof}
\begin{esempio}
...
\begin{esempio}
	...
	\left[\mathbb{Q}(\sqrt{D}):\mathbb{Q}\left(\frac{1}{2}\right)\right]\left[\mathbb{Q}(\frac{1}{2}):\mathbb{Q}\right]\\
	&=2\cdot1
	\end{align*}
