...
\begin{proof}
	...
	\begin{itemize}
		...
		\item[(iniettiva)] Vediamo che $\ker \phi = \left\{1\right\}$: se $x \in \ker \phi$ allora $\phi(x) = 1$. Per definizione di ordine $g^x = 1$ allora $n \mid x$; da cui dev'essere che $x \equiv n \equiv 0 \mod n$, ovvero $x \equiv 0 \in \mathbb{Z}_n$. 
...
\begin{controesempio}
	...
	\end{cases}
	\end{equation*}
	La prima ci dice che $x = 4k + 2$ e quindi è pari; la seconda invece che $x = 2k + 1$ ovvero dispari. Un numero intero non può essere sia pari che dispari da cui la contraddizione.
\end{controesempio}
\begin{osservazione}
	...
	%todo: il senso di questa osservazione? Serve a introdurre la condizione sotto per l'esistenza di una soluzione
\end{osservazione}
...
\begin{proof}
	...
	\begin{itemize}
		...
		% TODO:É spiegato male: la funzione non è iniettiva, ha nucleo non banale. Però il nucleo, il fatto che la mappa è ben definita e suriettiva come omomorfismo tra anelli ci permette di usare il primo teorema di isomorfismo tra anelli. Questo ci regala un isomorfismo, ma la mappa $\phi$ definita sopra NON è l'isomorfismo. (te lo lascio a te dato che il mio stile è abbastanza convoluto e molte volte lascia a desiderare)
