...
\end{definizione}
\begin{definizione}
	Un elemento di $F$ è algebrico su $K$ se è radice di un polinomio a coefficienti in $K$, l'estensione si dice \textbf{algebrica} se ogni $\alpha\in F$ è algebrico in $K$.
\end{definizione}

Chiaramente tutti gli elementi di $K$ sono algebrici su $K$, 
