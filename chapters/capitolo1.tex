...
\begin{proof}
	...
	\end{equation*}
	Chiaramente $X$ è non vuoto, ammette un minimo ed un massimo in $\mathbb{N}$. \\ Sia $n_0$ il minimo, sia $a_0 \in I$ tale che $f(a_0)=n_0$. Ora prendo un $b \in I$ con $b=a_0q+r$ per certi $q$ ed $r$ con $q,r\in A$. Ottengo $r=b-a_0q\in I$, quindi $r=0$ per scelta di $a_0$ come minimo di $X$ per gli $a\in I$ non-nulli; allora $b=a_0q$ ed ottengo $I\subset(a_0)$ per generalità di $b$. Siccome l'altra inclusione è banalmente vera - essendo $a_0$ elemento di $I$ ideale - ottengo la tesi, $I=(a_0)$.
\end{proof}
\begin{esempio}
...
\end{align*}
questo se $xy$ 
%todo: non xy^{-1}? No, serve che xy non sia 0, ovvero né x, né y sono 0. Infatti se uno dei due fosse 0 non ammetterebbe inverso
...
\begin{proof}
	...
	\begin{equation*}
	\sum_{k=1}^{\frac{p-1}{2}}k\equiv-n\equiv n\Mod2
	\end{equation*}
	Utilizzando $\sum_{k=1}^{\frac{p-1}{2}}k=\frac{p-1}{2}\left(\frac{p-1}{2}+1\right)\frac{1}{2}$ ed il lemma di Gauss otteniamo
	\begin{equation*}
...
\begin{proof}
	...
	\end{equation*}
	dove $n$ è preso dal lemma di Gauss. Questo implicherà $\leg{a}{p}=(-1)^{\sum_{k=1}^{\frac{p-1}{2}}\left[\frac{ka}{p}\right]}$. Esattamente come fatto nella dimostrazione del secondo complemento scrivo $ka=\left[\frac{ka}{p}\right]p+t_k$ e riscrivo le sommatorie viste, ma per $a$ dispari.
	\begin{equation*}
...
\begin{esempio}
	...
	Il polinomio carattersitico si può calcolare nella solita maniera come $\det(Ix - m_z) = x^2 - 2x -6$, ma esso 
...
\begin{proposizione}\
	\begin{enumerate}
		...
		\item Sia $F$ un campo numerico ed $I$ un ideale di $\mathcal{O}_F$ non nullo, valgono i seguenti fatti:
		\begin{enumerate}
			\item $I\cap\mathbb{Z}\neq\left\{0\right\}$
